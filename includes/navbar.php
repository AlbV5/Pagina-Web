    ...
    <nav class="navbar navbar-expand-xl navbar-light fixed-top" style="background-color: rgba(128, 0, 58, 0.822);">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          ...
          <li class="nav-item">
              <a class="nav-link active text-white menuprincipal" aria-current="page" href="index.php">Inicio</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link text-white menuprincipal" href="proyecto.php">Proyectos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white menuprincipal" href="#">Contactanos</a>
            </li>
          </ul>
